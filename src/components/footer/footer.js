            ...
            <div class="footer__content">
                ...
                <div class="footer__links--container">
                    <ul class="footer__main">
                        <div class="col__01">
                            <li>
                                <button data-path="/about-us">About Us</button>
                            </li>
                            <li>
                                <button data-path="/coming-soon">Press Room</button>
                            </li>
                        </div>

                        <div class="col__02">
                            <li>
                                <button data-path="/career">Careers</button>
                            </li>
                            <li>
                                <button data-path="/contact-us">Contact Us</button>
                            </li>
                        </div>
                    </ul>
                    ...
                    <ul class="footer__secondary">
                        <li>
                            <button data-path="/coming-soon">Investors</button>
                        </li>
                        <li>
                            <button data-path="/coming-soon">Nutrition & Allergens</button>
                        </li>
                        <li>
                            <button data-path="/community-impact">Community Impact</button>
                        </li>
                        <li>
                            <button data-path="/coming-soon">Corporate Sustainability</button>
                        </li>
                    </ul>
                    ...
                    <ul class="footer__legal">
                        ...
                        <div class="socials__text">
                            <li>
                                <button data-path="/coming-soon">Trust Center</button>
                            </li>
                            <li>
                                <button data-path="/coming-soon">Terms of Use</button>
                            </li>
                            <li>
                                <button data-path="/coming-soon">Privacy Policy</button>
                            </li>
                            <li>
                                <button data-path="/coming-soon">Accessibility</button>
                            </li>
                            <li>
                                <button data-path="/coming-soon">Health Data Notice</button>
                            </li>
                        </div>

                        <div class="socials__icons">
                            <li>
                                <button data-path="/coming-soon"><i class="fa-brands fa-facebook"></i>
                                    <svg 
                            ...
                            <li>
                                <button data-path="/coming-soon"><i class="fa-brands fa-twitter"></i>
                            ...
                            <li>
                                <button data-path="/coming-soon"><i class="fa-brands fa-instagram"></i>
